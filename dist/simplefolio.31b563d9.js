...
})({"hGalF":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 63503;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (viewWorkBtn) viewWorkBtn.addEventListener('click', function(e) {
        e.preventDefault();
        // Multiple approaches to find projects section
        let projectsSection = document.getElementById('projects');
        if (!projectsSection) projectsSection = document.querySelector('#projects');
        if (!projectsSection) projectsSection = document.querySelector('section[id="projects"]');
        if (projectsSection) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["hGalF","a0t4e"], "a0t4e", "parcelRequire6aa4", {})
